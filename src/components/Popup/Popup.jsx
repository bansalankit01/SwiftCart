...
const Popup = ({ orderPopup, setOrderPopp }) => {
        ...
        <div className='h-screen w-screen fixed top-0 left-0 bg-black/50 z-50 backdrop-blur-sm'>
            <div className='fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-4 shadow-md bg-white dark:bg-gray-900 rounded-md duration-200 w-[300px]'>
                ...
                <div className='flex items-center justify-between'>
                    ...
                    <div >
                       <IoCloseOutline className='text-2xl cursor-pointer' onClick={() => setOrderPopp(false)} />
                    </div>
                </div>
                ...
                <div className='mt-4'>
                    ...
                    <div className='flex justify-center'>
                        <button onClick={() => alert("Your order is confirmed")} className='bg-primary transition-all duration-200 text-white  py-1 px-4 rounded-full flex items-center gap-3 group'>Order Now</button>
                    </div>
                </div>
