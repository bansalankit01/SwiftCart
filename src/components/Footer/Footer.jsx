...
const Footer = () => {
  return (
    <div className="md:mx-10 mx-5 mt-12 rounded-3xl text-white bg-pink-300/20 dark:bg-teal-100/20 bg-opacity-30 backdrop-blur-lg border border-white/20 dark:border-white/30 md:w-[95%] w-[90%]">
